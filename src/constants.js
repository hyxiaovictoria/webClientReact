...
export const TOPICS_API_URL = `${SERVER_URL1}/topics`;
export const WIDGETS_API_URL = `${SERVER_URL1}/widgets`;
...
export const LESSONS_TOPICS_API_URL = (lessonId) =>  `${SERVER_URL1}/lessons/${lessonId}/topics`
export const TOPICS_WIDGETS_API_URL = (topicId) => `${SERVER_URL1}/topics/${topicId}/widgets`
